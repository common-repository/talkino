...
class Talkino_Settings {
	...
	public function customization_chatbox_section_callback( $args ) {
		...
		<p id="<?php echo esc_attr( $args['id'] ); ?>"><?php esc_html_e( 'Advanced features to customize the colors of Talkino based on your own design. To customize the Talkino using coding, please refer ', 'talkino' ); ?>
        	<a href="https://traxconn.com/blog/talkino/talkino-advanced-customization/" target="_blank"><?php esc_html_e( 'here', 'talkino' );?></a>.
		</p>
		<?php
	...
	public function ga_api_field_callback() {
		...
		<!-- Setting description -->
		<p>
			<span class="talkino-setting-description"><?php esc_html_e( 'Click ', 'talkino' ); ?><a href="https://traxconn.com/blog/talkino/how-do-i-integrate-talkino-with-typebot-and-google-analytics-ga4/" target="_blank"><?php esc_html_e( 'here', 'talkino' ); ?></a> <?php esc_html_e( ' to learn on how to setup Google Analytics (GA4) and how to get Measurement Id and API Secret.', 'talkino' ); ?></span>
		</p>
		<?php
	...
	public function recaptcha_secret_key_field_callback() {
		...
		<!-- Setting description -->
		<p>
			<span class="talkino-setting-description"><?php esc_html_e( 'Click ', 'talkino' ); ?><a href="https://traxconn.com/blog/talkino/the-way-to-set-up-a-contact-form-in-talkino/" target="_blank"><?php esc_html_e( 'here', 'talkino' ); ?></a> <?php esc_html_e( ' to learn on how to get the Google reCaptcha v3 Site Key and Secret Key.', 'talkino' ); ?></span>
		</p>
		<?php

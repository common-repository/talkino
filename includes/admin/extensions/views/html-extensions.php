...
<div class="container py-3 talkino">
    <header>
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom talkino">
            <a href="https://traxconn.com/wordpress-plugins/talkino-premium/" class="d-flex align-items-center text-dark text-decoration-none talkino">
            ...
            <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto talkino">
                ...
                <a class="me-3 py-2 text-dark text-decoration-none talkino" href="https://traxconn.com/blog/tag/talkino/">Documentation</a>
        ...
        <div class="pricing-header p-3 pb-md-4 mx-auto text-center talkino">
            <h1 class="display-4 fw-normal talkino">Talkino Premium</h1>
            ...
            <button type="button" class="btn btn-lg btn-primary talkino" onclick="location.href='https://traxconn.com/wordpress-plugins/talkino-premium/'">Get Started</button>
        </div>
    </header>
    <main>
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3 talkino">
            <div class="col d-flex align-items-start talkino">
                <div>
                    ...
                    <p class="fs-6 talkino">Talkino provides integration with Typebot virtual assistant to answer many questions that don't require a real agent as if you created a list of frequently asked questions. As a bot is available 24 hours a day, you will save a great deal of money and your customers will be happier with your service.</p>
                </div>
            </div>
            <div class="col d-flex align-items-start talkino">
                <div>
